...
address snes_addr(
  ...
  //PAR MK3 wrapper
  .parmk3_sel_bios(parmk3_sel_bios),
  .parmk3_sel_game(parmk3_sel_game),
  .parmk3_sel_mk3sram(parmk3_sel_mk3sram),
  .parmk3_sram_offset(parmk3_sram_offset),
  .parmk3_bios_offset(parmk3_bios_offset)
);

/* ----- Pro Action Replay MK3 wrapper ---------------------------------- */
wire        parmk3_sel_bios, parmk3_sel_game, parmk3_sel_mk3sram;
wire [14:0] parmk3_sram_offset;
wire [16:0] parmk3_bios_offset;
wire        parmk3_bus_override;
wire [7:0]  parmk3_bus_override_data;
wire        parmk3_soft_reset;
wire [1:0]  parmk3_mode;
wire [7:0]  parmk3_leds;
/* Programmed by the MCU through FPGA_CMD_PARMK3_CTRL (see mcu_cmd.v). */
...
parmk3_top snes_parmk3(
  ...
  .sram_offset(parmk3_sram_offset),
  .bios_offset(parmk3_bios_offset),
  .bus_override(parmk3_bus_override),
...
assign SNES_DATA = (r213f_enable & ~SNES_PARD) ? (r213f_forceread ? 8'bZ : r213fr)
                   ...
                   :(((~SNES_READ & ((~SNES_SNOOPPAWR_DATA_OE & ~SNES_SNOOPPARD_DATA_OE) | ~SNES_ROMSEL_EARLY)))
                                ...
                                ? (srtc_enable ? SRTC_SNES_DATA_OUT
                                  ...
                                  :parmk3_bus_override ? parmk3_bus_override_data
